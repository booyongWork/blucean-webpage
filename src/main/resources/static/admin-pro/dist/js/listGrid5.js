...
const gridLoad5 = () => {
    ...
    Grid5.setLanguage('ko');

    // Toast UI Grid4 구성하기
    grid5 = new Grid5({
        // ================================== 공통 옵션 적용 ==============================
        el: $("#grid5")[0],    // [필수] Container element
    ...
    * */
    ...
    $("#grid5").on('focusin', function(e) {
        previousFocusElement = $(document.activeElement);
    });

    // 탭 버튼 클릭 이벤트 핸들러
    $("#url-pill").on("click", function () {
        grid5.refreshLayout();
    });

    // Add Row 버튼 클릭 이벤트 핸들러
    $("#rowAppend5").on("click", function () {
        grid5.appendRow({});
    });
