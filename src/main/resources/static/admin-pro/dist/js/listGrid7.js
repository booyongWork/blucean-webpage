...
const gridLoad7 = () => {
    ...
    Grid7.setLanguage('ko');

    // Toast UI Grid4 구성하기
    grid7 = new Grid7({
        // ================================== 공통 옵션 적용 ==============================
        el: $("#grid7")[0],    // [필수] Container element
    ...
    * */
    ...
    $("#grid7").on('focusin', function(e) {
        previousFocusElement = $(document.activeElement);
    });

    // Add Row 버튼 클릭 이벤트 핸들러
    $("#rowAppend7").on("click", function () {
        grid7.appendRow({});
    });
