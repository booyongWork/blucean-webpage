...
const gridLoad4 = (data) => {
    $("#grid4").html("");

    // 그리드 생성
    const Grid4 = tui.Grid;
    /**
    ...
    Grid4.setLanguage('ko');

    // Toast UI Grid4 구성하기
     grid4 = new Grid4({
        // ================================== 공통 옵션 적용 ==============================
        el: $("#grid4")[0],    // [필수] Container element
    ...
    * */
    ...
    $("#grid4").on('focusin', function(e) {
        previousFocusElement = $(document.activeElement);
    });

    // 탭 버튼 클릭 이벤트 핸들러
    $("#interFace-pill").on("click", function () {
        grid4.refreshLayout();
    });
    ...
    function getGrid4Row(grid4) {
        // 추가된 로우들만 추출
      return grid4.getSelectedItem();
    }
